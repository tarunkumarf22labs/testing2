...
const SimilarStays = ({
  name, city, state, image, amenities, basicPrice, inVillaDetails,duration
  ...
  return (
    <motion.div className={`${inVillaDetails ? 'w-full max-w-[290px] md:max-w-[373px]' : 'w-[284px] max-w-[500px] md:max-w-[500px] md:w-[500px] '}`}
    animate={controls}
 ...
 //    whileHover={{ scale: 1.2 }}
    >
      <Image
        ...
        height={0}
        sizes="100vw"
        className={`bg-red-500 object-cover aspect-video ${inVillaDetails ? 'w-[290px] h-[182px] md:w-[373px] md:h-[234px]' : 'w-full h-[180px] md:h-[300px]'}`}
