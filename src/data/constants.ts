...
export const inclusions = [
  ...
  'Daily Cleaning daily room & bathroom cleaning, bed making, light house cleaning timings vary daily',
  'Final Cleaning, Linen Change weekly bed & bath linen changing',
  'Basic Supplies are available free such as detergent, shampoo, hand wash, shower gel, toilet paper',
  'Starter Food Supplies such as sugar, salt, tea, coffee, milk, basic spices, cooking oil',
  'Parking Open-air for up to 2 cars',
  'Welcome Dinner courtesy of LUL, Kerala vegetarian or non-veg meal, excluding beverages for minimum 5-night stays only',
  'Luxunlock Concierge Service for welcome & farewell, villa orientation and 24x7 phone assistance'
];

export const exclusions = [
  'The villa is part of a private community shared with five other houses. Certain areas of the estate are accessible for owner-residents only.',
  'Villa staff are available only during the day at specified timings. No staff permanently on-site.',
  'Food is not included in the villa rental. Cooking services are offered - homestyle Kerala cuisine only.',
  'No staff or drivers accommodation available at the villa or on the estate. Outside lodgings available 5-minutes away.',
  'Estate main gates are locked between 7 PM and 7AM. A set of gate keys will be handed over to you on arrival. Please lock the gate after yourselves.',
...
export const detailedDescription = {
  ...
  listPara: [
    ...
    {
      heading: 'Interior Spaces',
      detail: `The Living Room has a three seater sofa set and two elegant single chairs. The north wall has a set of three water-colours by Rajeshwar Rao. Elegant art-nouveau lamps from Hyderabad lend a warm glow to the room. The south wall is adorned by a large acrylic painted by the homeowner’s daughter.​
...
export const curatedExperiences = 'STAY LONGER';
export const experiencesAndAttraction = 'LOCAL EXPERIENCES';
