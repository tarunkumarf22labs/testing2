...
import {
  ...
  homeOwnersBannerImage,
  homeOwnersListProps
} from 'src/Props/home-owners';
    ...
    <Layout title="Home-Owners">
      <div>
        <div className="relative mt-16 bg-red-500 h-[219px] md:h-[min(72vh,810px)] md:-mt-[100px]">
          ...
          />
        <h1 className="absolute top-[50%] md:top-[62%] lg:top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] text-2xl sm:text-4xl md:text-5xl text-[#F8F8F9] uppercase font-light">
          HOME OWNERS
        </h1>
        </div>
        ...
        <div className="flex flex-col items-center justify-between m-auto mt-16 mb-20 md:flex-row md:max-w-7xl gap-14">
          <div className="w-11/12 pl-5 m-auto -mt-1 md:w-full">
            <HomeOwnersList homeOwnersListProps={homeOwnersListProps(data)} />
          </div>
          <div className="w-11/12 pr-5 ml-[5%] sm:ml-[4%] md:w-full">
            <ContactDetails />
          </div>
        </div>
        <div className="w-full bg-[#F8F8F9]">
          <div className="m-auto mt-16 mb-20 md:max-w-7xl bg-[#F8F8F9] pt-20 pb-20 pl-5">
            ...
            {HomeOwnerReviewsCardProps(data)?.length > 0 && (
              <HomeOwnerReviews
                HomeOwnerReviewsCardProps={HomeOwnerReviewsCardProps(data)}
              />
            )}
          </div>
        </div>
